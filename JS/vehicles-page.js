...
function EmeyaRedirect() { 
    location.replace("emeya-discover.html"); 
}

function EvijaRedirect(){
    location.replace("evija-discover.html");
}

function EmiraRedirect(){
    location.replace("emira-discover.html");
}

function ElectreRedirect(){
    location.replace("electre-discover.html");
}